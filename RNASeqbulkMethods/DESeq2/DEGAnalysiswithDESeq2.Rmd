...
Our very first step is to load the libraries we'll need to acsess the functions required for analysis and graphing. Please see [Bioconductor](http://bioconductor.org/) for information about initial installation and use of Bioconductor and its packages.
