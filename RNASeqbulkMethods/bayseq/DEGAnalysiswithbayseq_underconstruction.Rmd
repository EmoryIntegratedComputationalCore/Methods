...
p_load("readr", "dplyr", "knitr", "tidyr", "baySeq",
       "DESeq2", "vsn", "ggplot2", "EnhancedVolcano", "pheatmap")
...
stopifnot(nrow(results_df) == 288 & ncol(results_df) == 12)
```
...
EnhancedVolcano(volcano,
                ...
                subtitle= "Log(2) Fold Change vs -log(10) FDR values",
                legendPosition = "bottom",
                legend=c("NS", "Log2 fold-change", "FDR",
