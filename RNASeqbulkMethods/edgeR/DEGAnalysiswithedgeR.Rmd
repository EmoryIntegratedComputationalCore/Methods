...
require ("pacman")
p_load("readr", "abind","dplyr", "knitr", "tidyr", "edgeR", 
...
```{r exploratory pca, fig.height=6, fig.width=6}
...
In this example we see that while controlling the adjustedp/FDR threshold at <0.05, we have no DE genes betwen these groups.
...
```{r visualize, echo=FALSE, fig.height=5, fig.width=5, message=FALSE}
