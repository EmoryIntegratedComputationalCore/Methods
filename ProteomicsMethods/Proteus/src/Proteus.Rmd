...
sensitivity and specificty over popular tools like Perseus.
...
related tools like edgeR for differential expression of RNASeq data and GOSeq
...
To plot the Pearson coorelations of each sample compared to other samples in the
...
it plotDM_custom. These are small cosmetic changes we can accomodate if you have
