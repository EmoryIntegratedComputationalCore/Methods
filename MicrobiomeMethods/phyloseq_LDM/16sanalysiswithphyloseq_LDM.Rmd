...
(alphadivplot <- plot_richness(GP, "SubjGroup", measures=alpha_meas) + 
  geom_boxplot(aes(SubjGroup,value,fill=SubjGroup), size=0.5, alpha=0.6) + 
...
```{r fit global model, message=FALSE}
...
```{r fit local model, message=FALSE}
